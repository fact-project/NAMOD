...
//======================================================================
std::string pointing_direction::get_x_tilt_prompt_in_deg_min_sec()const{
	return get_angle_text_prompt_in_deg_arc_min_arc_sec(direction_in_x_in_radiant);
}
//======================================================================
std::string pointing_direction::get_y_tilt_prompt_in_deg_min_sec()const{
	return get_angle_text_prompt_in_deg_arc_min_arc_sec(direction_in_y_in_radiant);
}
//======================================================================
std::string pointing_direction::get_x_tilt_prompt_in_deg()const{
...
//======================================================================
std::string pointing_direction::get_y_tilt_prompt_in_deg()const{
...
//======================================================================
std::string pointing_direction::get_angle_text_prompt_in_deg_arc_min_arc_sec(
	double angle_in_rad
)const {
...
//======================================================================
pointing_direction pointing_direction::operator*(const double ScaleFactor) const{
	pointing_direction temp;
	
	temp.direction_in_x_in_radiant = ScaleFactor*direction_in_x_in_radiant;
	temp.direction_in_y_in_radiant = ScaleFactor*direction_in_y_in_radiant;
	
	return temp;
}
//======================================================================
pointing_direction pointing_direction::operator+(const pointing_direction dir_to_add) const{
...
pointing_direction pointing_direction::operator/(const double ScaleFactor)const {
	...
	pointing_direction temp;
	temp.direction_in_x_in_radiant = direction_in_x_in_radiant/ScaleFactor;
	temp.direction_in_y_in_radiant = direction_in_y_in_radiant/ScaleFactor;
	
	return temp;	
}
//======================================================================
pointing_direction pointing_direction::operator-(const pointing_direction dir_to_sub) const {
	pointing_direction temp;
	
	temp.direction_in_x_in_radiant = 
	direction_in_x_in_radiant - dir_to_sub.direction_in_x_in_radiant;
	
	temp.direction_in_y_in_radiant = 
	direction_in_y_in_radiant - dir_to_sub.direction_in_y_in_radiant;
	
	return temp;
}
//======================================================================
double pointing_direction::get_x_tilt_in_deg()const{
	return direction_in_x_in_radiant*360.0/(2.0*M_PI);
}
//======================================================================
double pointing_direction::get_y_tilt_in_deg()const{
...
//======================================================================
void pointing_direction::set_sccan_run_number_of_highest_response(
...
//======================================================================
pointing_direction::pointing_direction(
	const double dir_x_in_rad,
	const double dir_y_in_rad,
	uint sccan_run_number
){
	number_of_sccan_point_run_for_brightest_response = sccan_run_number;
...
//======================================================================
std::string pointing_direction::get_print()const {
	std::stringstream out;
	out << "x: " << get_x_tilt_prompt_in_deg_min_sec() << ", y: ";
	out << get_y_tilt_prompt_in_deg_min_sec();
	return out.str();
}